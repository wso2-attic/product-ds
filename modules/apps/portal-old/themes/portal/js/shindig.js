...
(window.___jsl.ci = window.___jsl.ci || []).push({opensocial: {invalidatePath: "http://%host%//rpc", path: "http://%host%//rpc", domain: "shindig", supportedFields: {person: ["id", {name: ["familyName", "givenName", "unstructured"]}, "thumbnailUrl", "profileUrl"], mediaItem: "album_id created description duration file_size id language last_updated location mime_type num_comments num_views num_votes rating start_time tagged_people tags thumbnail_url title type url".split(" "), album: "id thumbnailUrl title description location ownerId".split(" "), group: ["id",
    ...
    "core.io": {unparseableCruft: "throw 1; < don't be evil' >", jsonProxyUrl: "//%host%//gadgets/makeRequest", jsPath: "//gadgets/js", proxyUrl: "//%host%//gadgets/proxy?container=%container%&refresh=%refresh%&url=%url%%authz%%rewriteMime%", xhrPollIntervalMs: 50}});
window.___jsl = window.___jsl || {};
...
window.gadgets.config || (gadgets.config = function () {
    ...
    function n(a) {
        var b = "";
        if (3 == a.nodeType || 4 == a.nodeType)b = a.nodeValue; else if (a.innerText)b = a.innerText; else if (a.innerHTML)b = a.innerHTML; else if (a.firstChild) {
            b = [];
    ...
    function o(a) {
        var b = (f["core.io"] || {}).jsPath || null, e = [], d = 0, c = document.scripts || document.getElementsByTagName("script");
        if (c && 0 != c.length) {
            for (var h = 0; h < c.length; ++h) {
                var g = c[h].src, i = null != b && g && g.indexOf(b) || -1;
                -1 != i && /.*[.]js.*[?&]c=[01](#|&|$).*/.test(g.substring(i + b.length)) && (e[d++] = c[h])
            }
    ...
    function m(a) {
        for (var b in i)if (i.hasOwnProperty(b))for (var e = i[b], d = 0, c = e.length; d < c; ++d)a(b, e[d])
    }

    var k, i = {}, f = {}, l = !1;
    return{register: function (a, b, e, d) {
        var c = i[a];
        c || (c = [], i[a] = c);
        ...
        m(function (a, d) {
            var c = f[a];
            if (c && !b) {
                var h = d.validators, g;
                for (g in h)if (h.hasOwnProperty(g) && !h[g](c[g]))throw Error('Invalid config value "' +
...
(function () {
    ...
    var g = {"0": !1, 10: !0, 13: !0, 34: !0, 39: !0, 60: !0, 62: !0, 92: !0, 8232: !0, 8233: !0, 65282: !0, 65287: !0, 65308: !0, 65310: !0, 65340: !0};
...
(function () {
    ...
    gadgets.util.getUrlParameters = function (a) {
        ...
        for (var f = {}, a = a || document.location.href, d = a.indexOf("?"), b = a.indexOf("#"), a = (-1 === b ? a.substr(d + 1) : [a.substr(d + 1, b - d - 1), "&", a.substr(b + 1)].join("")).split("&"), d = window.decodeURIComponent ? decodeURIComponent : unescape, b = 0, h = a.length; b < h; ++b) {
            var c = a[b].indexOf("=");
            if (-1 !== c) {
                var i = a[b].substring(0, c), c = a[b].substring(c + 1), c = c.replace(/\+/g, " ");
                try {
                    f[i] = d(c)
                } catch (j) {
                }
...
window.JSON && (window.JSON.parse && window.JSON.stringify) && (gadgets.json = function () {
    ...
    return{parse: function (a) {
        ...
        var b = window.JSON.stringify, f = Array.prototype.toJSON && '"[{\\"x\\": 1}]"' === b([
            {x: 1}
        ]) ? c : b;
        try {
...
if (!window.JSON || !window.JSON.parse || !window.JSON.stringify)gadgets.json = function () {
    ...
    var f = {"\u0008": "\\b",
        "\t": "\\t", "\n": "\\n", "\u000c": "\\f", "\r": "\\r", '"': '\\"', "\\": "\\\\"};
    return{stringify: e, parse: function (a) {
...
shindig.Auth = function () {
    ...
    gadgets.config.register("shindig.auth", null, function (a) {
        var b = gadgets.util.getUrlParameters(), a = a["shindig.auth"] || {};
...
gadgets.rpctx.flash || (gadgets.rpctx.flash = function () {
    ...
    function o() {
        if (null === e && document.body && j) {
            var a = j + "?cb=" + Math.random() + "&origin=" + D + "&jsl=1", b = document.createElement("div");
            b.style.height = "1px";
            b.style.width = "1px";
    ...
    function x(a, b, c) {
        var b = gadgets.rpc.getTargetOrigin(a), d = gadgets.rpc.getAuthToken(a);
        e["sendMessage_" + (".." === a ? gadgets.rpc.RPC_ID : a) + "_" + d + "_" + (".." === a ? "INNER" : "OUTER")].call(e, gadgets.json.stringify(c), b);
        return!0
    }

    function y(a, b) {
        var c = gadgets.json.parse(a), d = c[z];
    ...
    var E = "___xpcswf", j = null, C = !1, B = null, A = null, e = null, q = 100, F = 50, h = [], g = null, H = 500, c = null, p = 0, z = "_scr", I = "_pnt", u = 100, G = 50, t = 0, f = null, k = {}, D = window.location.protocol + "//" + window.location.host, n, m = function () {
        window.___jsl = window.___jsl || {};
    ...
    return{getCode: function () {
        ...
        h.push({token: b, targetId: a});
        null === e && null === c && (c = window.setTimeout(o, q));
        l();
        return!0
    }, call: x, _receiveMessage: y, _ready: v, _setupDone: w}
}());
gadgets.rpctx = gadgets.rpctx || {};
gadgets.rpctx.frameElement || (gadgets.rpctx.frameElement = function () {
    ...
    var b = "__g2c_rpc", c = "__c2g_rpc", e, g;
    return{getCode: function () {
        return"fe"
    },
        isParentVerifiable: function () {
...
gadgets.rpctx.nix || (gadgets.rpctx.nix = function () {
    ...
    var c = "GRPC____NIXVBS_get_wrapper", h = 10, i = 500, d = {},
        e, g = 0;
    return{getCode: function () {
        return"nix"
    }, isParentVerifiable: function () {
...
gadgets.rpctx.rmr || (gadgets.rpctx.rmr = function () {
    ...
    function j(a) {
        ...
        if (d || g && 0 < b.queue.length)m(a, gadgets.rpc.ACK, ".." === a ? gadgets.rpc.RPC_ID : "..", {ackAlone: d})
    }
    ...
    var r = 500, q = 10, f = {}, s = gadgets.util.getUrlParameters().parent, o, n;
    return{getCode: function () {
        return"rmr"
    }, isParentVerifiable: function () {
        return!0
        ...
        try {
            if ("object" !== typeof f[a]) {
                ...
                e || (e = d + "/robots.txt");
                f[a] = {frame: b, receiveWindow: null, relayUri: e, relayOrigin: d, searchCounter: 0, width: 10, waiting: !0, queue: [], sendId: 0, recvId: 0, verifySendToken: "" + Math.random(), verifyRecvToken: null, originVerified: !1};
                ".." !== a && k(b, e, h(a));
                l(a)
            }
        } catch (g) {
...
gadgets.rpctx.ifpc || (gadgets.rpctx.ifpc = function () {
    ...
    function l(d) {
        for (var b, c = f.length - 1; 0 <= c; --c) {
            var a = f[c];
            try {
                if (a && (a.recyclable || "complete" === a.readyState))if (a.parentNode.removeChild(a), window.ActiveXObject)f[c] = a = null, f.splice(c, 1); else {
                    a.recyclable = !1;
                    b = a;
                    break
                }
    ...
    return{getCode: function () {
        ...
        var g = null, h = [];
        if (c.l)g = [a, "#", k([b, i, 1,
            0, k([b, c.s, "", "", b].concat(c.a))])].join(""), h.push(g); else for (var g = [a, "#", d, "&", b, "@", i, "&"].join(""), d = encodeURIComponent(gadgets.json.stringify(c)), b = 2E3 - g.length, c = Math.ceil(d.length / b), a = 0, e; 0 < d.length;)e = d.substring(0, b), d = d.substring(b), h.push([g, c, "&", a, "&", e].join("")), a += 1;
        do l(h.shift()); while (0 < h.length);
        return!0
    }, _receiveMessage: function (d, b) {
        var c = d[1], a = parseInt(d[2], 10), g = parseInt(d[3], 10), h = d[d.length - 1], f = 1 === a;
        if (1 < a) {
            e[c] || (e[c] = []);
            e[c][g] = h;
            a:{
                for (a -= 1; 0 <= a; --a)if ("undefined" === typeof e[c][a]) {
                    a = !1;
                    break a
                }
                a = !0
...
window.gadgets.rpc || (gadgets.rpc = function () {
    ...
    function R(a, b, c, d, e) {
        ...
        e.onunload = function () {
            g[b] && !I && (r(b, K), gadgets.rpc.removeReceiver(b))
        };
        Q();
    ...
    function s(a, b) {
        if (a && ("string" === typeof a.s && "string" === typeof a.f && a.a instanceof Array) && ("function" !== typeof arbitrate || arbitrate(a.s, a.f)))if (j[a.f] && j[a.f] !== a.t && (gadgets.error("Invalid auth token. " + j[a.f] + " vs " + a.t), r(a.f, x)), "__ack" === a.s)window.setTimeout(function () {
            w(a.f, true)
        }, 0); else {
    ...
    function m(a) {
        ...
        var a = a.substring(0, a.indexOf("://")), c = "", d = b.indexOf(":");
        if (-1 != d) {
    ...
    function p(a) {
        if ("/" == a.charAt(0)) {
            var b = a.indexOf("|"), c = 0 < b ? a.substring(1, b) : a.substring(1), a = 0 < b ? a.substring(b + 1) : null;
    ...
    function U(a, b) {
        function c(c) {
            c = c ? c.rpc : {};
            M(c);
            var e = c.parentRelayUrl || "", e = m(l.parent || b) + e;
    ...
    function O(a, b, c) {
        if (".." === a)U(c || l.rpctoken || l.ifpctok || "", b); else a:{
            var d = null;
            if ("/" != a.charAt(0)) {
    ...
    var S = "referer", k = {}, A = {}, u = {}, j = {}, E = 0, F = {}, g = {}, f = {}, l = {}, n = {}, o = {}, v = null, D = null, V = !!gadgets.util.getUrlParameters().parent && window.top !== window.self, G = window.name, r = function () {
    }, K = 1, x = 2, H = window.console, P = H && H.log ? function (a) {
        H.log(a)
    } : function () {
    }, q = function () {
        function a(a) {
    ...
    return{config: function (a) {
        ...
        ++E;
        c && (F[E] = c);
        var f = {s: b, f: e, c: c ? E : 0, a: Array.prototype.slice.call(arguments,
            3), t: j[a], l: !!u[a]}, h;
        a:if ("bidir" === v || "c2p" === v && ".." === a || "p2c" === v && ".." !== a) {
            h = window.location.href;
            var g = "?";
            if ("query" === D)g = "#"; else if ("hash" === D)break a;
            g = h.lastIndexOf(g);
            g = -1 === g ? h.length : g;
            h = h.substring(0, g)
        } else h = null;
        h && (f.r = h);
        if (!(".." !== a && null == p(a) && !document.getElementById(a)) && !T(a, f))if (h = n[a], !h && null !== p(a) && (h = i), h) {
            if (u[a] && (h = gadgets.rpctx.ifpc), !1 === h.call(a, e, f))n[a] = q, i.call(a, e, f)
        } else o[a] ? o[a].push(f) : o[a] = [f]
    }, getRelayUrl: z, setRelayUrl: B, setAuthToken: C, setupReceiver: O,
        ...
        }, getOrigin: m, getTargetOrigin: function (a) {
            var b = null, b = z(a);
        ...
        }, _getTargetWin: y, _parseSiblingId: p, ACK: "__ack", RPC_ID: G || "..", SEC_ERROR_LOAD_TIMEOUT: 0, SEC_ERROR_FRAME_PHISH: K, SEC_ERROR_FORGED_MSG: x}
}(), gadgets.rpc.init());
    ...
    return function (i) {
        ...
        function n(a) {
            ...
            for (var a = a.split("&"), d = 0, c = a.length; d < c; ++d) {
                var l = a[d].split("="), f = l.shift(), e = null;
        ...
        var j = "", k = "", m = "", g = "", c = null, h = "", f = null, D = window.decodeURIComponent ? decodeURIComponent : unescape, q = window.encodeURIComponent ? encodeURIComponent : escape, e = null;
        "object" === typeof i && "function" === typeof i.toString ? o(i.toString()) : i && o(i);
        return e = {getSchema: function () {
            return j
        }, getAuthority: function () {
            return k
        },
            getOrigin: z, getPath: function () {
                return m
            }, getQuery: r, getFragment: s, getQP: t, getFP: v, setSchema: function (a) {
                j = a;
                return e
                ...
                h = A(a, "#");
                return e
            }, setQP: w, setFP: y, setExistingP: function (a, b) {
...
gadgets.io = function () {
    ...
    function u(c, d, a, b) {
        r(b, d) || d(o(a, {body: b.responseText}))
    }

    function p(c, d, a, b) {
        if (!r(b, d)) {
            var b = b.responseText, h = m.unparseableCruft, g = b.indexOf(h) + h.length;
            g < h.length || (b = b.substr(g), b = eval("(" + b + ")"), b = b[c], b.oauthState && (n = b.oauthState), b.st && shindig.auth.updateSecurityToken(b.st), d(o(a, b)))
        }
    }

    function o(c, d) {
        var a = {text: d.body, rc: d.rc || 200, headers: d.headers, oauthApprovalUrl: d.oauthApprovalUrl, oauthError: d.oauthError, oauthErrorText: d.oauthErrorText, oauthErrorTrace: d.oauthErrorTrace, oauthErrorUri: d.oauthErrorUri, oauthErrorExplanation: d.oauthErrorExplanation, errors: []};
    ...
    return{makeRequest: function (c, d, a) {
        var a = a || {}, b = a.METHOD || "GET", h = a.REFRESH_INTERVAL, g, j;
        ...
        var l = gadgets.util.getUrlParameters(), e = {url: c, httpMethod: b, headers: gadgets.io.encodeValues(k, !1), postData: a.POST_DATA || "", authz: g || "", st: j || "", contentType: a.CONTENT_TYPE || "TEXT", numEntries: a.NUM_ENTRIES || "3", getSummaries: !!a.GET_SUMMARIES, signOwner: e, signViewer: f, gadget: l.url, container: l.container || l.synd || "default", bypassSpecCache: gadgets.util.getUrlParameters().nocache || "", getFullHeaders: !!a.GET_FULL_HEADERS};
        if ("oauth" === g || "signed" === g || "oauth2" === g) {
            ...
            e.oauthState = n || "";
            for (var i in a)if (a.hasOwnProperty(i) && (0 === i.indexOf("OAUTH_") || "code" === i))e[i] = a[i]
        }
        g = (j = j || shindig.auth.getSecurityToken()) ? {"X-Shindig-ST": j} : {};
        j = m.jsonProxyUrl.replace("%host%", document.location.host);
        a:{
            if (gadgets.io.preloaded_ && "GET" === e.httpMethod)for (i = 0; i < gadgets.io.preloaded_.length; i++)if ((f =
                gadgets.io.preloaded_[i]) && f.id === e.url) {
                delete gadgets.io.preloaded_[i];
                200 !== f.rc ? d({rc: f.rc, errors: [f.rc + " Error"]}) : (f.oauthState && (n = f.oauthState), d(o(a, {body: f.body, rc: f.rc, headers: f.headers, oauthApprovalUrl: f.oauthApprovalUrl, oauthError: f.oauthError, oauthErrorText: f.oauthErrorText, oauthErrorTrace: f.oauthErrorTrace, oauthErrorUri: f.oauthErrorUri, oauthErrorExplanation: f.oauthErrorExplanation, errors: []})));
                i = !0;
                break a
            }
            i = !1
        ...
        var g = gadgets.util.getUrlParameters(), j = shindig.auth.getSecurityToken(), e = b[gadgets.io.RequestParameters.AUTHORIZATION], f = b[gadgets.io.RequestParameters.OAUTH_SERVICE_NAME], b = b.rewriteMime ? "&rewriteMime=" + encodeURIComponent(b.rewriteMime) : "", k = "";
...
osapi._BoundCall.prototype.execute = function (b) {
    var d = "undefined" !== typeof caja___ && caja___.getUseless && caja___.getUseless(), a = d ? caja___.getUseless() : this, c = d ? caja___.untame(b) : b, b = osapi.newBatch();
...
(function () {
    function i(e, d) {
        var c = {POST_DATA: gadgets.json.stringify(e), CONTENT_TYPE: "JSON", METHOD: "POST", AUTHORIZATION: "SIGNED"}, f = {"Content-Type": "application/json"}, a = this.name, g = shindig.auth.getSecurityToken();
        g && (h ? f.Authorization = "OAuth2 " + g : a = a + "?st=" + encodeURIComponent(g));
        gadgets.io.makeNonProxiedRequest(a, function (b) {
            if (b.errors[0])d({error: {code: b.rc, message: b.text}}); else {
                b = b.result || b.data;
                if (b.error)d(b); else {
    ...
    function j(e) {
        var d =
            e["osapi.services"];
        h = e["osapi.useOAuth2"];
        if (d)for (var c in d)if (d.hasOwnProperty(c) && (0 == c.indexOf("http") || 0 == c.indexOf("//")))for (var e = {name: c.replace("%host%", document.location.host), execute: i}, f = d[c], a = 0; a < f.length; a++)osapi._registerMethod(f[a], e)
    }
...
osapi.container.ContainerConfig = {ALLOW_DEFAULT_VIEW: "allowDefaultView", RENDER_CAJOLE: "renderCajole", RENDER_DEBUG: "renderDebug", RENDER_DEBUG_PARAM: "renderDebugParam", RENDER_TEST: "renderTest", TOKEN_REFRESH_INTERVAL: "tokenRefreshInterval", NAVIGATE_CALLBACK: "navigateCallback", PRELOAD_REF_TIME: "preloadRefTime", PRELOAD_METADATAS: "preloadMetadatas", PRELOAD_TOKENS: "preloadTokens", GET_LANGUAGE: "GET_LANGUAGE", GET_COUNTRY: "GET_COUNTRY", GET_PREFERENCES: "GET_PREFERENCES", SET_PREFERENCES: "SET_PREFERENCES", RPC_ARBITRATOR: "rpcArbitrator",
    GET_GADGET_TOKEN: "GET_GADGET_TOKEN", GET_CONTAINER_TOKEN: "GET_CONTAINER_TOKEN"};
...
osapi.container.util.newMetadataRequest = function (a) {
    ...
    return{container: window.__CONTAINER, ids: a, fields: "iframeUrls modulePrefs.* needsTokenRefresh userPrefs.* views.preferredHeight views.preferredWidth expireTimeMs responseTimeMs rpcServiceIds tokenTTL".split(" ")}
};
...
osapi.container.SiteHolder.prototype.createIframeAttributeMap = function (c, b) {
    var a = this.renderParams_ || {}, a = {id: this.iframeId_, name: this.iframeId_, src: c, scrolling: "no", marginwidth: 0, marginheight: 0, frameborder: 0, vspace: 0, hspace: 0, "class": a[osapi.container.RenderParam.CLASS], height: a[osapi.container.RenderParam.HEIGHT], width: a[osapi.container.RenderParam.WIDTH], onload: this.onLoad_ ? "window." + this.onLoad_ + "('" + this.getUrl() + "', '" + this.site_.getId() + "');" : void 0};
...
osapi.container.GadgetHolder.prototype.doOaaIframeHtml_ = function () {
    ...
    new OpenAjax.hub.IframeContainer(gadgets.pubsub2router.hub, this.iframeId_, {Container: {onSecurityAlert: function (a, b) {
    ...
    }}, IframeContainer: {parent: this.el_, uri: this.getIframeUrl_(), tunnelURI: shindig.uri(this.relayPath_).resolve(shindig.uri(window.location.href)),
        iframeAttrs: this.createIframeAttributeMap(this.getIframeUrl_()), onGadgetLoad: this.onLoad_}})
};
...
osapi.container.GadgetSite.prototype.setModuleId_ = function (b, c, d) {
    if (c && this.moduleId_ != c) {
        var a = this, b = osapi.container.util.buildTokenRequestUrl(b, c);
...
osapi.container.GadgetSite.prototype.navigateTo = function (b, c, d, a) {
    ...
    this.service_.getGadgetMetadata(osapi.container.util.newMetadataRequest([b]), function (a) {
        var j = !e ? osapi.container.util.getCurrentTimeMs() - f : 0, i = a[b];
...
osapi.container.GadgetSite.prototype.render = function (b, c, d) {
    ...
    var f = function (a) {
        if ("undefined" !== typeof a && null != a)for (var a = a.aliases || [], c = 0; c < a.length; c++)if (b[osapi.container.MetadataResponse.VIEWS][a[c]])return{view: a[c], viewInfo: b[osapi.container.MetadataResponse.VIEWS][a[c]]};
        return null
    }, a = d[osapi.container.RenderParam.VIEW] || c[osapi.container.ViewParam.VIEW] || a, e = b[osapi.container.MetadataResponse.VIEWS][a];
    if (a && !e) {
...
(function () {
    ...
    var d = {}, j = 1, e = {open: function (a, b, c, e) {
        var g = a + ":" + c + ":" + b, f = this.getWindow(a, b);
        if (f) {
            var h = j++, k = gadgets.util.makeClosure(this, function (a) {
                this.closeWindow(f);
...
osapi.container.Service = function (a) {
    this.container_ = a;
    var a = this.config_ = a.config_ || {}, b = /^([^\/]*\/\/[^\/]+)(.*)$/.exec(((gadgets.config.get("osapi") || {}).endPoints || [window.__API_URI.getOrigin() + "/rpc"])[0]);
...
(function () {
    ...
    osapi.container.Service.prototype.updateContainerSecurityToken =
        function (a, f, l) {
            var j = osapi.container.util.getCurrentTimeMs(), i = "boolean" != typeof f && f || void 0, f = "boolean" == typeof f && f;
...
osapi.container.Container.prototype.newGadgetSite = function (a, b) {
    var c = new osapi.container.GadgetSite(this, this.service_, {navigateCallback: this.navigateCallback_, gadgetEl: a, bufferEl: b || null, gadgetOnLoad: osapi.container.CallbackType.GADGET_ON_LOAD});
    return this.sites_[c.getId()] = c
};
osapi.container.Container.prototype.navigateGadget = function (a, b, c, d, e) {
    var f = e || function () {
    }, e = osapi.container.ContainerConfig, g = osapi.container.RenderParam;
    ...
    if (this.config_[e.GET_PREFERENCES] && !d[g.USER_PREFS])this.config_[e.GET_PREFERENCES](a.getId(), b, i); else i(d[g.USER_PREFS])
};
...
osapi.container.Container.prototype.preloadCaches = function (a) {
    var b = osapi.container.util.getSafeJsonValue(a, osapi.container.ContainerConfig.PRELOAD_METADATAS, {}), c = osapi.container.util.getSafeJsonValue(a, osapi.container.ContainerConfig.PRELOAD_TOKENS, {}), a = osapi.container.util.getSafeJsonValue(a, osapi.container.ContainerConfig.PRELOAD_REF_TIME, null);
...
osapi.container.Container.prototype.scheduleRefreshTokens_ = function (a) {
    ...
    if (this.isRefreshTokensEnabled_() && (!this.tokenRefreshTimer_ || d != c))if (a = osapi.container.util.getCurrentTimeMs(),
...
osapi.container.Container.prototype.setRefreshTokenInterval_ = function (a) {
    if (a) {
        var a = 0.8 * a, b = this.tokenRefreshInterval_;
...
osapi.container.Container.prototype.setupRpcArbitrator_ = function (a) {
    ...
    if ("undefined" !== typeof b.enableRpcArbitration && b.enableRpcArbitration) {
        ...
        if (!a)var c = this, a = function (a, b) {
...
osapi.container.Container.prototype.refreshTokens_ = function () {
    var a = this.getTokenRefreshableGadgetUrls_(), b = this;
        ...
        for (var d in b.sites_) {
            ...
            if (e instanceof osapi.container.GadgetSite) {
                ...
                if (f && b.service_.getCachedGadgetMetadata(f.getUrl())[osapi.container.MetadataResponse.NEEDS_TOKEN_REFRESH]) {
                    var e = e.getModuleId(), e = osapi.container.util.buildTokenRequestUrl(f.getUrl(), e), g = a[e];
...
(function () {
    osapi.container.Container.addMixin("ee", function (e) {
        function r(b, a, h, f, k) {
            var c = h[osapi.container.ee.RenderParam.GADGET_VIEW_PARAMS] || {}, n = h[osapi.container.ee.RenderParam.GADGET_RENDER_PARAMS] || {};
            ...
            var o = e.newGadgetSite(b), m = a[g.GADGET];
            e.preloadGadget(m, function (d) {
                !d[m] || d[m].error ? a[g.URL] != null ? q(b, a, h, f) : f != null && f(o, d[m] || {error: d}) : e.navigateGadget(o, m, c, n, function (a) {
                    f != null && f(o, a)
                })
            })
        }
        ...
        var g = osapi.container.ee.DataModel,
            i = osapi.container.ee.PreferredExperience, s = osapi.container.ee.TargetType, p = osapi.container.ee.Context, j = osapi.container.ee.ContainerConfig;
        e.rpcRegister("ee_gadget_rendered", function (b) {
            return(b = b.gs.currentGadgetHolder_.renderParams_.eeDataModel) ? b[g.CONTEXT] : null
        });
        return{navigate: function (b, a, h, f, k) {
            var c = null;
            if (e.config_ && e.config_[j.GET_EE_NAVIGATION_TYPE] && "function" === typeof e.config_[j.GET_EE_NAVIGATION_TYPE])c = e.config_[j.GET_EE_NAVIGATION_TYPE].call(e, a); else a:{
                if (a[g.PREFERRED_EXPERIENCE] &&
                    (c = a[g.PREFERRED_EXPERIENCE], c[i.TARGET] && (c = c[i.TARGET]) && c[i.TYPE]))if (c = c[i.TYPE], osapi.container.ee.TargetType.URL === c && "undefined" !== typeof a.url || osapi.container.ee.TargetType.GADGET === c && "undefined" !== typeof a.gadget)break a;
                c = null
            }
...
gadgets.json.xml = function () {
    function i(b, c) {
        for (var e = 0; e < b.length; e++) {
            var a = b[e];
            if (a.nodeType == k)l(c, a.nodeName, a); else if (0 == a.childNodes.length)if (null != a.attributes && 0 != a.attributes.length) {
                var d = a, a = c, g = a[d.nodeName];
                if (null == g)a[d.nodeName] = {}, h(d.attributes, a[d.nodeName]); else {
                    var f = {};
                    h(d.attributes, f);
                    a[d.nodeName] = j(g, f)
                }
            } else c[a.nodeName] = null; else 1 == a.childNodes.length && a.firstChild.nodeType == k && (null == a.attributes || 0 == a.attributes.length) ? l(c, a.nodeName, a.firstChild) : (d = c, g = d[a.nodeName],
    ...
    var k = 3;
    return{convertXmlToJson: function (b) {
        var c =
        {};
        i(b.childNodes, c);
        return c
...
osapi.container.Container.addMixin("views", function (h) {
    ...
    h.rpcRegister("gadgets.views.openEmbeddedExperience", function (a, m, b, c) {
        var i = a.callback, k = a.f, e = b.gadget;
        if ("string" == typeof b)if ((a = /^<(embed)>/i.exec(b)) && a[1])try {
            var f = gadgets.json.xml.convertXmlToJson(opensocial.xmlutil.parseXML(b)), b = f && f[a[1]] || b
        } catch (p) {
        } else try {
        ...
        var d = function (g) {
            ...
            var l = h.getGadgetSiteByIframeId_(k), o = l.getActiveSiteHolder().getIframeElement(), n = j.getContainerAssociatedContext(b, g);
            (g = j.createElementForEmbeddedExperience(o, g, a, d, l, e)) && e(g)
        };
        e ? h.preloadGadget(e, function (a) {
            (!a[e] || a[e].error) && !b.url ? null != i && i([null, a[e] || {error: a}]) : d(a[e])
        }) : d()
    });
...
osapi.container.Container.addMixin("views", function (e) {
    ...
    e.rpcRegister("gadgets.views.openGadget", function (d, n, a) {
        var g = d.callback, o = d.f, c = "", b = e.getGadgetSiteByIframeId_(d.f);
...
osapi.container.Container.addMixin("views", function (c) {
    ...
    c.rpcRegister("gadgets.views.openUrl", function (d, h, a, i) {
        ...
        var f = c.getGadgetSiteByIframeId_(d.f), j = f.getActiveSiteHolder().getIframeElement();
...
(function () {
    ...
    osapi.container.Container.addMixin("opensearch",
        function (a) {
            ...
            return{getOpenSearchURLs: function (a) {
                return k(a, !0)
                ...
                for (index in e)if (e[index] == a)return e.splice(index, 1), !0;
                return!1
            }}
        })
})();
...
OpenAjax.hub || (OpenAjax.hub = function () {
    var a = {};
    return{implementer: "http://openajax.org", implVersion: "2.0.7", specVersion: "2.0", implExtraData: {}, libraries: a, registerLibrary: function (b, c, d, e) {
        a[b] = {prefix: b, namespaceURI: c, version: d, extraData: e};
...
}(), OpenAjax.hub.Error = {BadParameters: "OpenAjax.hub.Error.BadParameters", Disconnected: "OpenAjax.hub.Error.Disconnected", Duplicate: "OpenAjax.hub.Error.Duplicate",
...
}, OpenAjax.hub.ManagedHub = function (a) {
    if (!a || !a.onPublish || !a.onSubscribe)throw Error(OpenAjax.hub.Error.BadParameters);
    this._p = a;
    ...
    this._pubQ = []
}, OpenAjax.hub.ManagedHub.prototype.subscribeForClient = function (a, b, c) {
    this._assertConn();
    ...
    if (this._invokeOnSubscribe(a, null)) {
        var g =
            this, a = this._subscribe(a, f, c, e);
    ...
    var e = a + "." + this._seq,
        b = {scope: c, cb: b, data: d, sid: this._seq++};
    ...
    var e = b[c];
    c == b.length ? (d.next = a.s, a.s = d) : ("undefined" == typeof a.c && (a.c = {}), "undefined" == typeof a.c[e] && (a.c[e] = {c: {}, s: null}), this._recursiveSubscribe(a.c[e], b, c + 1, d))
}, OpenAjax.hub.ManagedHub.prototype._publish = function (a, b, c) {
    if (this._isPublishing)this._pubQ.push({t: a, d: b, p: c}); else for (this._safePublish(a, b, c); 0 <
    ...
    if ("undefined" != typeof a && (c != b.length && (this._recursivePublish(a.c[b[c]], b, c + 1, d, e, f), this._recursivePublish(a.c["*"], b, c + 1, d, e, f), a = a.c["**"]), "undefined" != typeof a))for (a = a.s; a;) {
        var b =
            a.scope, c = a.cb, g = a.data;
    ...
    return null
}, OpenAjax.hub._hub = new OpenAjax.hub.ManagedHub({onSubscribe: function () {
    return!0
}, onPublish: function () {
    return!0
...
(function () {
    if ("undefined" === typeof gadgets) {
        if ("undefined" === typeof oaaConfig)for (var j = document.getElementsByTagName("script"), e = /openajax(?:managedhub-(?:all|core).*|-mashup)\.js$/i, i = j.length - 1; 0 <= i; i--) {
...
OpenAjax.hub.IframeContainer || function () {
    OpenAjax.hub.IframeContainer = function (e, i, f) {
        function m() {
            ...
            var d = '<iframe id="' + c + '" name="' + c + '" src="javascript:\'<html></html>\'"', l = "", b = f.IframeContainer.iframeAttrs;
            if (b)for (var e in b)switch (e) {
                case "style":
        ...
        var g = this, k = f.Container.scope || window, a = !1, d =
        {}, o, c, s = f.IframeContainer.timeout || 15E3, r, n = f.Container.log ? function (a) {
            try {
    ...
    OpenAjax.hub.IframeHubClient = function (e) {
        ...
        var m = this, j = e.HubClient.scope || window, h = !1, b = {}, p = 0, g, k = e.HubClient.log ? function (a) {
            try {
        ...
        this._init = function () {
            var a =
                OpenAjax.gadgets, b = a.util.getUrlParameters();
    ...
    OpenAjax.hub.IframeContainer._rpcRouter = function () {
        ...
        return{add: function (m, q) {
            ...
            OpenAjax.gadgets.rpc.config({securityCallback: i});
...
OpenAjax.hub.InlineContainer = function (a, c, d) {
    ...
    var h = d.Container.scope || window, g = !1, j = [], p = 0, o = null, q = d.Container.log ? function (b) {
        try {
    ...
    this.subscribe = function (b, c, e, d, g) {
        ...
        l = null;
        try {
            var m = a.subscribeForClient(this, b, i), n = !0
        } catch (o) {
            i = null, l = o.message
        }
        e = e || window;
        n && (j[i] = {h: m, cb: c, sc: e, d: g});
        f(d, e, i, n, l);
        return i
    };
...
OpenAjax.hub.InlineHubClient = function (a) {
    ...
    var c = a.InlineHubClient.container, d = a.HubClient.scope || window;
...
OpenAjax._smash.crypto = {strToWA: function (a, b) {
    ...
    var c = [43417, 15926, 18182, 33130, 9585, 30800, 49772, 40144, 47678, 55453, 4659, 38181, 65340, 6787, 54417, 65301], d = [], g = 0;
    b(a);
    return{addSeed: function (a) {
        b(a)
...
gadgets.pubsub2router = function () {
    return{init: function (a) {
        this.hub = a.hub ? a.hub : new OpenAjax.hub.ManagedHub({onPublish: a.onPublish, onSubscribe: a.onSubscribe, onUnsubscribe: a.onUnsubscribe})
    }}
}();
